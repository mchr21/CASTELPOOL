...
class RolesController extends Component
{
    ...
    public function CreateRole()
    {
        ...
        $this->dispatch('role-added', 'Se registró el role con éxito');
        $this->resetUI();
    }
    ...
    public function UpdateRole()
    {
        ...
        $this->dispatch('role-updated', 'Se actualizó el role con éxito');
        $this->resetUI();
    }
    ...
    public function Destroy($id)
    {
        ...
        if ($permissionsCount > 0) {
            $this->dispatch('role-error', 'No se puede eliminar el role porque tiene permisos asociados');
            return;
        }

        Role::find($id)->delete();
        $this->dispatch('role-deleted', 'Se eliminó el role con éxito');
    }

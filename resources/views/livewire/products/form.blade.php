...
<div class="col-sm-12 col-md-8">
	<div class="form-group">
		...
		<input id="inputNombre"type="text" wire:model.blur="name" 
...
<div class="col-sm-12 col-md-4">
	<div class="form-group">
		...
		<input id="inputCodigo" type="text" wire:model.blur="barcode" 
		class="form-control"
...
<div class="col-sm-12 col-md-4">
	<div class="form-group">
		...
		<input id="inputCosto"type="text" data-type='currency' wire:model.blur="cost" class="form-control" placeholder="ej: 0.00" >
...
<div class="col-sm-12 col-md-4">
	<div class="form-group">
		<label for="inputPrecio" >Precio</label>
           <input id="inputPrecio" type="text" data-type='currency' wire:model.blur="price" class="form-control" placeholder="ej: 0.00" > 
...
<div class="col-sm-12 col-md-4">
	<div class="form-group">
		...
		<input id="inputStock"type="number"  wire:model.blur="stock" class="form-control" placeholder="ej: 0" >
...
<div class="col-sm-12 col-md-4">
	<div class="form-group">
		...
		<input id="inputAlert"type="number"  wire:model.blur="alerts" class="form-control" placeholder="ej: 10" >

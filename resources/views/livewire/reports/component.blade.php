                    ...
                    <div class="col-sm-12 col-md-3">
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-2">
                                <h6>Fecha desde</h6>
                                <div class="form-group">
                                    <input type="text" wire:model="dateFrom" class="form-control flatpickr" placeholder="Click para elegir"> {{--flatpickr es un tipo de calendario--}}
                                </div>
                            </div>
                            <div class="col-sm-12 mt-2">
                                <h6>Fecha hasta</h6>
                                <div class="form-group">
                                    <input type="text" wire:model="dateTo" class="form-control flatpickr" placeholder="Click para elegir"> {{--flatpickr es un tipo de calendario--}}
                                </div>
                            </div>
                            <div class="col-sm-12">
...
<script>
    document.addEventListener('DOMContentLoaded', function(){
        flatpickr(document.getElementsByClassName('flatpickr'),{ //va a buscar los controles que tenga esa caja de texto ('flatpickr')
            enableTime: false, //porq no necesitamos la hora
            dateFormat: 'Y-m-d',
            locale: {
                firstDayofWeek: 1, //ubica el primer dia de la semana
                weekdays: { //copiamos de https://github.com/flatpickr/flatpickr/blob/master/src/l10n/es.ts

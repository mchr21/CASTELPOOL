		...
		<table cellpadding="0" cellspacing="0" width="100%">
			<tr>
				<td colspan="2" class="text-center">
					<span style="font-size: 25px; font-weight: bold;">Sistema CastelPool</span>
				</td>
			</tr>
			<tr>
				<td width="30%" style="vertical-align: top; padding-top: 10px; position: relative">
					<img src="{{ asset('assets/img/logo3.png') }}" alt="" class="invoice-logo">
				</td>
				...
				<td width="70%" class="text-left text-company" style="vertical-align: top; padding-top: 10px">
					...
					@else
					{{-- <span style="font-size: 16px"><strong>Fecha de Consulta: {{ \Carbon\Carbon::now()}}</strong></span> --}}

...
---------------TODO ESTO NOS LLEVAMOS AL COMPONENTE search.blade.php----pero en su lugar ponemos lo siguiente para conectar--}}

<livewire:search-controller />
{{-- <livewire:search-controller> --}}

{{-- nos vamos a search.blade.php a realizar el script que permita la comunicacion --}}
                ...
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                    <div class="user-profile-section">
                        <div class="media mx-auto">
                            <img src="assets/img/pool.png" class="img-fluid mr-2" alt="avatar">
                            <div class="media-body">
                                <h5>Maribel Choque</h5>
                                <p>Developer</p>
                            </div>
                        </div>
                    </div>
